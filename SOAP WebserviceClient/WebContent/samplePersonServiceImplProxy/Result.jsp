...
<jsp:useBean id="samplePersonServiceImplProxyid" scope="session" class="com.ankit.soapws.service.PersonServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.ankit.soapws.service.PersonServiceImpl getPersonServiceImpl10mtemp = samplePersonServiceImplProxyid.getPersonServiceImpl();
...
case 15:
        ...
        %>
        <jsp:useBean id="com1ankit1soapws1bean1Person_1id" scope="session" class="com.ankit.soapws.bean.Person" />
        <%
        com1ankit1soapws1bean1Person_1id.setAge(age_2idTemp);
        com1ankit1soapws1bean1Person_1id.setName(name_3idTemp);
        com1ankit1soapws1bean1Person_1id.setId(id_4idTemp);
        boolean addPerson15mtemp = samplePersonServiceImplProxyid.addPerson(com1ankit1soapws1bean1Person_1id);
...
case 31:
        ...
        com.ankit.soapws.bean.Person getPerson31mtemp = samplePersonServiceImplProxyid.getPerson(id_6idTemp);
...
case 42:
        gotMethod = true;
        com.ankit.soapws.bean.Person[] getAllPersons42mtemp = samplePersonServiceImplProxyid.getAllPersons();
