...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.ankit.soapws.service.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8080/SOAP_Webservice/services/PersonServiceImpl";
    ...
    public com.ankit.soapws.service.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ankit.soapws.service.PersonServiceImplSoapBindingStub _stub = new com.ankit.soapws.service.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ankit.soapws.service.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ankit.soapws.service.PersonServiceImplSoapBindingStub _stub = new com.ankit.soapws.service.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.soapws.ankit.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.soapws.ankit.com", "PersonServiceImpl"));
        }
